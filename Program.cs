...
{
    // create a delegate
    public delegate void Ending(int n);
    public class Race
    {
        public event Ending RaceEnd; // create a delegate event object
        ...
        {
            Console.WriteLine("Woohoo! We have a winner!");
    ...
    class Program
    {
        public static void Main()
        {
            ...
            //trigger the event
            round1.Racing(10,8);
            // register with the bike race event using a lambda expression
            round1.RaceEnd -= carRace;
            round1.RaceEnd += (winner) => Console.WriteLine($"The winner of the race is bike {winner}!");
            // trigger the event
            round1.Racing(15,20);
